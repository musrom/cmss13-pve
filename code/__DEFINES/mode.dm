...
var/global/list/ROLES_AUXIL_SUPPORT = list(JOB_AUXILIARY_OFFICER, JOB_INTEL, JOB_PILOT, JOB_DROPSHIP_CREW_CHIEF, JOB_WO_CHIEF_POLICE, JOB_WO_SO, JOB_WO_CREWMAN, JOB_WO_POLICE, JOB_WO_PILOT, JOB_CREWMAN)
...
var/global/list/ROLES_SQUAD_ALL = list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_MECHANIZED, SQUAD_WEAPONS)
...
var/global/list/ROLES_AI_MECHANIZED = list(JOB_SO, JOB_GO, JOB_SQUAD_LEADER, JOB_CREWMAN, JOB_SQUAD_MEDIC, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_SMARTGUN, JOB_SQUAD_MARINE)
var/global/list/ROLES_AI_WEAPONS = list(JOB_SO, JOB_WO_XO, JOB_WO_PILOT, JOB_SQUAD_LEADER, JOB_SQUAD_MEDIC, JOB_SQUAD_ENGI, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_HMG, JOB_SQUAD_MARINE)
